...
13. For your "winning" model from question 4, attempt to perform some sort of cross validation for that model. If you get really stuck, show us the code you ran and explain where you are stuck. This is mostly to get you to attempt cross validation in your own work -- I'm not expecting perfect code.
